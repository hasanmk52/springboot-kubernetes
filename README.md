...
```shell
$ git clone https://github.com/hasanmk52/springboot-kubernetes.git
...
kubectl get pods
kubectl get all
kubectl run bookmarker-api --image=hasandocker53/bookmarker-api --restart=Never --port=8080 --labels=env=dev,version=1.0
kubectl get all
kubectl describe pods bookmarker-api
kubectl delete pods bookmarker-api

kubectl run bookmarker-api --image=hasandocker53/bookmarker-api --restart=Never --port=8080 --labels=env=dev,version=1.0 --dry-run=client -o yaml > pod.yaml
...
kubectl run bookmarker-api --image=hasandocker53/bookmarker-api --restart=Never --port=8080 -n dev -o yaml --dry-run=client > pod.yaml
...
```shell
kubectl create deployment bookmarker-api-deploy --image=hasandocker53/bookmarker-api
kubectl create deployment bookmarker-api-deploy --image=hasandocker53/bookmarker-api --dry-run=client -o yaml > deployment.yaml
...
kubectl set image deployment bookmarker-api-deploy bookmarker-api=hasandocker53/bookmarker-api:1.1
